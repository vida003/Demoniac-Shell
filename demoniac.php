    ...
    <body>
        ...
        <?php
            ...
            function makeFile($name, $content){
                if($file = fopen($name, 'w')){
                    fwrite($file, $content);
                    fclose($file);
                    echo "<script>alert('File created successfully to: {$file}');</script>";
                } else {
                    echo "<script>alert('Could not create file: {$file}')</script>";
                }
            }
        ...
        ?>
                ...
                <form method='POST' style='text-align: center;'>
                    ...
                    <span style='font-size: 25px;'>Pass: </span><input type='text' name='passSQL' required size='12'/><br><br>
